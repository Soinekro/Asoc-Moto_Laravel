<nav class="bg-gray-800" x-data="{ open: false }">
    <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <!-- Mobile menu button-->
            <div class="inset-y-1 sm:hidden items-center">
                <button @click="open = true"   type="button"
                    class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white"
                    aria-controls="mobile-menu" aria-expanded="false">
                    <span class="sr-only">Open main menu</span>

                    <svg class="md:hiden h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
            ...
            {{-- logotipo --}}
            <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start" x-open="!open">
                ...
                <div class="hidden sm:block sm:ml-6">
                    <div class="flex space-x-4">
                        ...
                        <a href="{{route('inicio')}}" class="bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium"
    ...
    <div class="sm:hidden" id="mobile-menu" x-show="open" x-on:click.away="open = false">
        <div class="px-2 pt-2 pb-3 space-y-1">
            <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
            <a href="{{route('inicio')}}" :active="request()->routeIs('inicio')" class="bg-gray-900 text-white block px-3 py-2 rounded-md text-base font-medium"
                aria-current="page">Inicio</a>

            <a href="{{route('contacto')}}" :active="request()->routeIs('contacto')"
